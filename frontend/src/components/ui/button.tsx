...
function Button({
  ...
  // For non-outline, non-ghost variants, show tooltip with shortcut
  if (shortcut && variant && variant !== 'outline' && variant !== 'ghost' && !asChild) {
    return (
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent side="top">
            <div className="flex">{renderKbd(shortcut)}</div>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    );
