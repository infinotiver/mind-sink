...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-2 left-1/2 transform -translate-x-1/2 px-3 py-2 shadow-md rounded-2xl z-50 flex items-center border-2 bg-accent/75 backdrop-blur-3xl w-[min(100%,_960px)]">
