...
function SinkCreate({
  ...
  return (
    <div className="w-auto flex-1 flex flex-col p-4">
      <div className="mb-4">
        <label htmlFor="sinkTitleInput" className="block text-sm font-medium text-foreground">
          Sink Title
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="sinkDescriptionInput" className="block text-sm font-medium text-foreground">
          Sink Description
        </label>
        <textarea
